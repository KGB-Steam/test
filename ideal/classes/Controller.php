...
class Controller extends Singleton{
	...
	public function renderGame($content) {
		$html = $this->_renderPartial($this->tplPath . 'empty.php', array('content'=>$content), false);
		$output = array('head'=>'', 'body'=>'');
	...
	public function renderPagePortfolio($content, $pattern) {
		$html = $this->_renderPartial($this->tplPath . 'portfolio/patterns/' . $pattern . '/index.html', array('content'=>$content), false);
		$output = array('head'=>'', 'body'=>'');
